...
def main(argv: list[str]) -> int:
    ...
    if args.dry_run_report:
        ...
        lines = [
            ...
            "## Checks applied",
            "",
            f"- summaries planned: {stats.summaries_written} of {stats.scanned} sessions scanned (a first run writes every completed session; later runs write only new ones).",
