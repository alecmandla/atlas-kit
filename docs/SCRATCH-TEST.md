...
F-10, F-22, and F-23 stay open for the maintainer: the reflection-practice exemplar and
the two profile-specific gaps are design decisions, not mechanical fixes.
